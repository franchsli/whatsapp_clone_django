...
urlpatterns = [
    ...
    path('archive_chat/<int:chat_id>/<str:archive>/', views.archive_chat, name='archive_chat'),
    ...
    path('create_status/<str:status_data>/', views.create_status, name='create_status'),
